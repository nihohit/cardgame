...
public static class LocationBasedCards {
	private static BaseCollection<Card> cards = new BaseCollection<Card>(new Card[] {
		...
		Card.MakeCard("Build Refinery Car",
			populationCost: 1,
			materialsChange: -1,
		...
		Card.MakeCard("Build Workhouse Car",
			populationCost: 1,
			materialsChange: -1,
		...
		Card.MakeCard("Build Cannon Car",
			populationCost: 1,
			materialsChange: -1,
		...
		Card.MakeCard("Build Armory Car",
			populationCost: 1,
			materialsChange: -1,
		...
		Card.MakeCard("Build Housing Car",
			populationCost: 1,
			materialsChange: -1,
